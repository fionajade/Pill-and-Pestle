<?php $title = "Pill and Pestle Medicine Stock"; $subhead = "Manage Inventory"; $page_title = "Medicine Stock";
                            ...
                            <?php foreach ($categories as $cat): ?>
                                <li
                                    ...
                                    <form method="POST" onsubmit="return confirm('Delete this category?')"
                                        ...
                                        <button name="delete_category" class="btn btn-outline-danger btn-sm rounded-pill"
                                ...
                                <?php foreach ($medicines as $med): ?>
                                    <div class="col-md-6">
                                        <div class="medicine-card">
                                            ...
                                            <p class="med-info">Expiry: <span
                                                    class="<?= (strtotime($med['expiry_date']) < strtotime('+30 days')) ? 'text-danger' : '' ?>"><?= $med['expiry_date'] ?></span>
                                            </p>
